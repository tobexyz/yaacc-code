 ...
 * hydrated device is then added to the {@link de.yaacc.upnp.registry.Registry}.
 * </p>
 * <p>
...
public class RetrieveRemoteDescriptors implements Runnable {
    ...
    private final UDA10DeviceDescriptorBinderImpl uda10DeviceDescriptorBinder = new UDA10DeviceDescriptorBinderImpl();
    private final UDA10ServiceDescriptorBinderImpl uda10ServiceDescriptorBinder = new UDA10ServiceDescriptorBinderImpl();
    ...
    public RetrieveRemoteDescriptors(Registry registry, HttpRequestSender httpRequestSender, RemoteDevice rd) {
    ...
    protected void describe(String descriptorXML) throws IOException {
        ...
        try {
            ...
            describedDevice = uda10DeviceDescriptorBinder.describe(
                    rd,
                    descriptorXML
            );
    ...
    protected RemoteService describeService(RemoteService service)
        ...
        try {
            ...
            YaaccLogger.w(getClass().getName(), "Could not retrieve service descriptor, got exception: " + service, e);
            return null;
        }
        ...
        return uda10ServiceDescriptorBinder.describe(service, descriptorContent);
    }

    protected List<RemoteService> filterExclusiveServices(RemoteService[] services) {
        ServiceType[] exclusiveTypes = YaaccUpnpServerService.EXCLUSIVE_SERVER_TYPES;
