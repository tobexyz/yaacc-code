...
![browse_servers](./5.2.x/browse_servers.png){:height="30%" width="30%"}
![browse_content_folder](./5.2.x/browse_content_folder.png){:height="30%" width="30%"}
![browse_image_folder](./5.2.x/browse_image_folder.png){:height="30%" width="30%"}
![browse_music_folder](./5.2.x/browse_music_folder.png){:height="30%" width="30%"}
![browse_receiver](./5.2.x/browse_receiver.png){:height="30%" width="30%"}
![music_player](./5.2.x/music_player.png){:height="30%" width="30%"}
![browse_player](./5.2.x/browse_player.png){:height="30%" width="30%"}
![image_player](./5.2.x/image_player.png){:height="30%" width="30%"}
![image_player_show_menu](./5.2.x/image_player_show_menu.png){:height="30%" width="30%"}
![server_control](./5.2.x/server_control.png){:height="30%" width="30%"}
![shutdown_timer](./5.2.x/shutdown_timer.png){:height="30%" width="30%"}
...
![browse_image_folder](./5.0.x/browse_image_folder.png){:height="30%" width="30%"}
![browse_music_folder](./5.0.x/browse_music_folder.png){:height="30%" width="30%"}
![browse_receiver](./5.0.x/browse_receiver.png){:height="30%" width="30%"}
![music_player](./5.0.x/music_player.png){:height="30%" width="30%"}
![browse_player](./5.0.x/browse_player.png){:height="30%" width="30%"}
![image_player](./5.0.x/image_player.png){:height="30%" width="30%"}
![image_player_show_menu](./5.0.x/image_player_show_menu.png){:height="30%" width="30%"}
![server_control](./5.0.x/server_control.png){:height="30%" width="30%"}
![shutdown_timer](./5.0.x/shutdown_timer.png){:height="30%" width="30%"}
